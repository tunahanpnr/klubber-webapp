...
public class PostController {
    ...
    public String createPost(@Valid @RequestBody final Users user, final SubClub subClub, final String content) {
        return postService.createPost(user, subClub, content);
    }
